...
<body>
       ...
       <div class="container">
            ...
            <form action="assets/includes/reg.inc.php" method="POST" class="card mx-auto show-form" id="regForm">
                ...
                <div class="card-body row">
                    ...
                    <div class="col-md-6 mb-2">
                        <select id="country" name="country" onclick="this.classList.toggle('text-white')" class="form-select bg-transparent text-white">
                            <option selected disabled>__Select Country__</option>
                    ...
                    <div class="col-md-6 mb-2">
                        <select name="gender" onclick="this.classList.toggle('text-white')" class="form-control bg-transparent text-white">
                            <option selected disabled>__Gender__</option>
    ...
    <script>
        function changeForm(){
            ...
            setTimeout(()=>{
                regForm.classList.toggle('show-form')
                logForm.classList.toggle('show-form')
            },50)
        }
    </script>
</body>
